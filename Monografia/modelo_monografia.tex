...
\begin{folhadeaprovacao}
  \begin{center}
   ...
   \assinatura{\textbf{Profª. Drª. Simone das Graças Domingues Prado} \\
   Universidade Estadual Paulista "Júlio de Mesquita Filho"\\
   Faculdade de Ciências \\
   Departamento de Ciência da Computação}
...
\input{text/chapters/introducao.tex}
\input{text/chapters/fundamentacao.tex}
\input{text/chapters/metodologia.tex}
\input{text/chapters/desenvolvimento.tex}
\input{text/chapters/resultados.tex}
\input{text/chapters/conclusao.tex}
